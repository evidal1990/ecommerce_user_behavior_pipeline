import polars as pl
from src.transformation.silver.normalize import (
    Normalize,
    MinMaxScaling,
    ...
    def start(
        ...
        return Normalize(
            [
                ...
                NormalizeRelationshipStatus(column="relationship_status"),
                NormalizePreferredPaymentMethod(column="preferred_payment_method"),
                NormalizeGender(column="gender"),
